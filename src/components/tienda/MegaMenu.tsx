    ...
    >
      ...
      {isOpen && (
        <div style={{
          ...
          maxWidth: '1200px',
          background: '#0d0d10',
          boxShadow: '0 25px 50px rgba(0, 0, 0, 0.9), 0 0 30px rgba(254, 166, 4, 0.1)',
          borderRadius: '16px',
          padding: '2rem',
          display: 'grid',
          ...
          {categoriesByRubro.map(rubro => (
            <div key={rubro.id}>
              <Link href={`${baseUrl}?rubro=${rubro.id}`} onClick={() => setIsOpen(false)}>
                <h3 style={{ fontSize: '0.9375rem', fontWeight: 800, marginBottom: '1rem', color: '#FFFFFF', borderBottom: '1px solid rgba(255, 255, 255, 0.1)', paddingBottom: '0.5rem', textTransform: 'uppercase', letterSpacing: '0.04em' }}>
                  {rubro.nombre}
                </h3>
              </Link>
