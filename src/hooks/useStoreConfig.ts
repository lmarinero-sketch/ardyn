...
export const STORE_DEFAULTS = {
  ...
  tienda_hero_mayorista: {
    ...
    imagen_fondo_url: '/hero-sportswear-v2.webp',
  ...
  tienda_footer: {
    ...
    telefono_fijo: '☎️ (0264) 424-1234',
    instagram: '@ardyn_suplementos',
    facebook: 'Ardyn Suplementos',
    tiktok: '@ardyn_suplementos',
    email_contacto: 'contacto@ardyn.com.ar',
    texto_creditos: 'Hecho por Grow Labs',
    url_creditos: 'https://www.growlabs.lat',
  },
  tienda_whatsapp: {
    numero_mayorista: '5492646796509',
    numero_minorista: '5492646796509',
    numero_consultas: '5492646796509',
    mensaje_mayorista: 'Hola Ardyn! Quiero hacer un pedido mayorista 🛒',
    mensaje_minorista: 'Hola Ardyn! Quiero consultar sobre productos 🛍️',
    mensaje_consulta: 'Hola Ardyn! Tengo una consulta sobre stock y envíos',
    ...
    url_sucursal_rawson: 'https://www.google.com/maps/search/?api=1&query=Mendoza+Sur+582,+Rawson,+San+Juan',
  },
